...
Manage a server's custom emoji. Requires the Manage Expressions permission.
...
Manage a server's custom stickers. Requires the Manage Expressions permission.
...
A sticker image must be a PNG or APNG at exactly 320x320, or a Lottie JSON,
and at most 512KB.
